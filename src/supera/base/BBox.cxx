...
namespace supera {
  ...
  {
    if(xmin > xmax) throw meatloaf("xmin > xmax not allowed for BBox3D construction!");
    if(ymin > ymax) throw meatloaf("ymin > ymax not allowed for BBox3D construction!");
    if(zmin > zmax) throw meatloaf("zmin > zmax not allowed for BBox3D construction!");
  }
  ...
  void BBox3D::update(double xmin, double ymin, double zmin,
    double xmax, double ymax, double zmax)
  {
    if(xmin > xmax) throw meatloaf("xmin > xmax not allowed for BBox3D::Update!");
    if(ymin > ymax) throw meatloaf("ymin > ymax not allowed for BBox3D::Update!");
    if(zmin > zmax) throw meatloaf("zmin > zmax not allowed for BBox3D::Update!");
  ...
  double BBox3D::area(int axis) const
  {
    ...
    throw meatloaf("BBox3D::area can only take axis=[0,1,2]!");
  }
